...
union bpf_attr
{
    ...
    struct
    { /* anonymous struct used by BPF_RAW_TRACEPOINT_OPEN command */
        __u64 name;
        __u32 prog_fd;
        __u32:32;
    ...
    struct
    { /* struct used by BPF_TOKEN_CREATE command */
        __u32 flags;
        __u32 bpffs_fd;
    } token_create;
...
struct bpf_link_info
{
    ...
    union
    {
        ...
        struct
        {
            __u32 attach_type;
            __u32
                target_obj_id; /* prog_id for PROG_EXT, otherwise btf object id */
        ...
        struct
        {
            ...
            __u32
                count; /* in/out: uprobe_multi offsets/ref_ctr_offsets/cookies count */
            __u32 flags;
            __u32 pid;
        } uprobe_multi;
