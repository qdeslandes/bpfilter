...
#define bft_mock_declare(ret, x, args)                                     \
...
#define bft_mock_will_return(mock, value)                                  \
    _will_return((mock).wrap_name, __FILE__, __LINE__, ((uintmax_t)(value)), 1)

#define bft_mock_will_return_always(mock, value)                           \
    _will_return((mock).wrap_name, __FILE__, __LINE__, ((uintmax_t)(value)), -1)

#define bft_mock_real(mock) __real_##mock
#define bft_mock_define(ret, x, args)                                      \
...
bft_mock_declare(struct btf *, btf__load_vmlinux_btf, (void));